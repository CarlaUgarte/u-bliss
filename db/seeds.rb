...
syllabus_descriptions = [
  ...
  'Este syllabus está orientado a emprendedores, inversionistas y profesionales que desean comenzar o expandir su negocio inmobiliario. A lo largo de este programa, aprenderás desde cómo investigar el mercado inmobiliario hasta cómo gestionar propiedades, conseguir financiamiento y aplicar estrategias efectivas para crecer tu negocio. Es un enfoque práctico y directo, diseñado para aquellos que buscan crear y mantener un negocio rentable en el sector inmobiliario, sin necesidad de tener experiencia previa.',
  ...
  Además, el curso proporcionará una visión cultural del idioma, permitiendo al estudiante comprender y adaptarse a situaciones cotidianas y profesionales. Cada módulo incluye lecturas recomendadas, ejercicios prácticos y recursos interactivos para asegurar una inmersión completa en el idioma. El programa está estructurado de manera progresiva para ayudar al estudiante a alcanzar un dominio práctico del inglés.",
  ...
  'Dirigido a aquellos que desean explorar la intersección entre la fotografía y el diseño gráfico, aprendiendo a transformar imágenes fotográficas en obras de arte visualmente impactantes. A través de módulos que combinan teoría y práctica, los participantes aprenderán a integrar técnicas fotográficas y de diseño gráfico para crear composiciones únicas. Mediante lecturas en español, se abordarán herramientas, conceptos clave y ejemplos prácticos de cómo usar la fotografía como elemento fundamental en el diseño gráfico.',
  "Diseñado para enseñar los fundamentos y técnicas de la carpintería, proporcionando las habilidades necesarias para transformar la madera en piezas funcionales y decorativas. A través de una serie de módulos, los participantes aprenderán desde cómo seleccionar los materiales adecuados, hasta el uso de herramientas básicas y avanzadas. Con la combinación de teoría y práctica, este enfoque incluye lecturas reales en español que profundizan en las mejores técnicas de carpintería, seguridad en el trabajo, y consejos para desarrollar un estilo personal en la creación de proyectos de madera.",
...
Category.all.each do |category|
  2.times do
    ...
    when 'El Camino del electricista: Formación integral para convertirse en técnico en electricidad'
      modules = [
